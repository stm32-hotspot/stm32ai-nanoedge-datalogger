...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOH, CS_DHCX_Pin|LED1_Pin|LED2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin : CS_DHCX_Pin */
